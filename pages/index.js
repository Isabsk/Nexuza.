      ...
      <div className="relative isolate px-6 pt-2 lg:px-2">
        ...
        <div className="mx-auto max-w-3xl py-6 sm:py-14 lg:py-20">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-6xl lg:text-7xl transition duration-300">
        ...
        >
          <div
            className="relative left-[calc(50%+3rem)] aspect-[1155/478] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#1150d9] to-[#04086b] opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
                'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)',
            }}
