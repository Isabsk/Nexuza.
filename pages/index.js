        ...
        <div className="relative isolate h-[84vh] px-6 pt-2 lg:px-2">
          ...
          <div className="mx-auto max-w-3xl py-6 sm:py-14 lg:py-14">
            ...
            <div className="text-center">
              <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 transition duration-300 dark:text-white sm:text-6xl lg:text-7xl">
                Expand your coding universe with
                <span className="bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent hover:bg-gradient-to-r hover:from-cyan-500 hover:to-blue-400">
                  &nbsp;Nexuza.
                </span>{' '}
              </h1>
